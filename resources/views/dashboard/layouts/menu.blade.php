<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="{{route('admin.home')}}"><img src="{{asset('assets/dashboard/images/logo.svg')}}" width="25" alt="Aero"><span class="m-l-10">Aero</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <a class="image" href="profile.html"><img src="{{asset('assets/dashboard/images/profile_av.jpg')}}" alt="User"></a>
                    <div class="detail">
                        <h4>Michael</h4>
